...
class JamTasktList extends \CBitrixComponent
{
    ...
    protected function _getData()
    {
        ...
        $arData = [];
        $arFilter = [
	        'IBLOCK_ID' => $this->arParams["IBLOCK_ID"], 'ACTIVE' => 'Y', 'PROPERTY_STATUSID' => [70,71]
        ];
        $arSelect = [
            "ID", "NAME", "DATE_ACTIVE_FROM", "PREVIEW_PICTURE", "DETAIL_PICTURE", "PREVIEW_TEXT", "DETAIL_TEXT", "PROPERTY_PRICE", "PROPERTY_CLIENT_ID", "PROPERTY_STATUSID", "PROPERTY_NUMBER",
        ];
        ...
        while ( $element = $rs->GetNextElement() ) {
            ...
            //return $arClientIn;
            $typeIdClient = $arFields["PROPERTY_CLIENT_ID_VALUE"];
            if( in_array( $typeIdClient, $arClientIn ) ){
